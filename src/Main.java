...
public class Main {
    ...
    public static void printMenu() {
        System.out.println("Что вы хотите сделать? "); //сделано
        System.out.println("1 - Записать дела на сегодня"); //сделано
        System.out.println("2 - Записать дела на другое число"); //сделано
        System.out.println("3 - посмотреть ваши дела"); //БООСССС ФАЙТ\\
        System.out.println("4 - посмотреть сегодняшнее число"); //сделано
        System.out.println("0 - Выйти из приложения"); //сделано
    }
